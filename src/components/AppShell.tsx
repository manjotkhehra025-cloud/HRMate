...
export default function AppShell({
  ...
  const nav: NavItem[] = [
    ...
    ...(has("attendance.view") || has("attendance.punch")
      ...
      : []),
    { href: "/roster", label: "Shift Roster", icon: <Clock className="h-5 w-5" /> },
    ...(has("leaves.view") || has("leaves.apply")
      ? [{ href: "/leaves", label: "Leaves", icon: <CalendarDays className="h-5 w-5" /> }]
      : []),
    { href: "/kra", label: "KRAs & Goals", icon: <Target className="h-5 w-5" /> },
    { href: "/calendar", label: "Calendar", icon: <CalendarIcon className="h-5 w-5" /> },
    { href: "/documents", label: "KYC & Letters", icon: <FolderLock className="h-5 w-5" /> },
    { href: "/recognition", label: "Star Workers", icon: <Trophy className="h-5 w-5" /> },
    { href: "/helpdesk", label: "Helpdesk", icon: <LifeBuoy className="h-5 w-5" /> },
    ...(has("wall.view")
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="hidden lg:flex h-10 w-10 items-center justify-center rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] text-[#0F172A] transition active:scale-95 hover:bg-[#F1F5F9] dark:border-[#1E293B] dark:bg-[#0F172A] dark:text-white"
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {/* Download App Quick Link (Web browser only, hidden inside native APK and on mobile) */}
          {!isNative && (
            <Link
              href="/download"
              className="hidden lg:flex h-10 items-center gap-1.5 rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] px-3 text-[12px] font-bold text-[#0F172A] transition active:scale-95 hover:bg-[#F1F5F9] dark:border-[#1E293B] dark:bg-[#0F172A] dark:text-white"
