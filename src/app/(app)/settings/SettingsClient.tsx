...
export default function SettingsClient({
  ...
  const { prefs, savePrefs, t } = usePrefs();
  ...
  async function togglePush() {
    ...
    if (nextState) {
      ...
      flash(t("appNotifications") + " " + t("activeStatus"));
    } else {
        ...
        <div className="space-y-6 lg:col-span-6">
          ...
          <section className="card p-6 border border-[#E3EAF1] shadow-[0_2px_12px_rgba(18,58,99,0.04)] space-y-4">
            <div className="flex items-center justify-between border-b border-[#F0F4F8] pb-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-[16px] font-bold text-[#172334]">{t("passkeys")}</h3>
                  <p className="text-[12px] text-[#8A97A8]">{t("passkeysSub")}</p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-[16px] border border-emerald-500/25 bg-emerald-50/40 p-4">
              <div className="flex items-center justify-between">
                ...
                >
                  {registering ? <Spinner className="h-4 w-4" /> : t("verifyScan")}
                </button>
              </div>
            </div>
          ...
          <section className="card p-6 border border-[#E3EAF1] shadow-[0_2px_12px_rgba(18,58,99,0.04)] flex items-center justify-between">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <h3 className="text-[15px] font-bold text-[#172334]">{t("appNotifications")}</h3>
                <p className="text-[12px] text-[#8A97A8]">
                  {pushEnabled ? t("notificationsActive") : t("notificationsMuted")}
                </p>
              </div>
            </div>
            ...
            >
              {pushEnabled ? t("activeStatus") : t("enableStatus")}
            </button>
          </section>
          ...
          <section className="card p-6 border border-[#E3EAF1] shadow-[0_2px_12px_rgba(18,58,99,0.04)] space-y-4">
            <div className="flex items-center gap-2.5 border-b border-[#F0F4F8] pb-3">
              ...
              <div>
                <h3 className="text-[16px] font-bold text-[#172334]">{t("display")}</h3>
                <p className="text-[12px] text-[#8A97A8]">{t("languageSub")}</p>
              </div>
            </div>
            ...
            <div>
              <label className="label flex items-center gap-1.5 font-bold text-[#172334]">
                <Languages className="h-4 w-4 text-[#1E6FE0]" /> {t("language")}
              </label>
            ...
            <div className="pt-2">
              <label className="label flex items-center gap-1.5 font-bold text-[#172334]">
                <SunMoon className="h-4 w-4 text-[#1E6FE0]" /> {t("appearance")}
              </label>
              <div className="grid grid-cols-3 gap-2 pt-1">
                {[
            ...
            <div className="pt-2">
              <label className="label flex items-center gap-1.5 font-bold text-[#172334]">
                <Type className="h-4 w-4 text-[#1E6FE0]" /> {t("textSize")}
              </label>
              <div className="grid grid-cols-3 gap-2 pt-1">
                {[
          ...
          <div className="space-y-6 lg:col-span-6">
            ...
            <section className="card p-6 border border-[#E3EAF1] shadow-[0_2px_12px_rgba(18,58,99,0.04)] space-y-4">
              <div className="flex items-center gap-2.5 border-b border-[#F0F4F8] pb-3">
                ...
                <div>
                  <h3 className="text-[16px] font-bold text-[#172334]">{t("attendanceArea")}</h3>
                  <p className="text-[12px] text-[#8A97A8]">{t("attendanceAreaSub")}</p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 pt-2 border-t border-[#F0F4F8]">
                <button type="button" className="btn-secondary text-xs" onClick={useMyLocation}>
                  <Navigation className="h-3.5 w-3.5 text-[#1E6FE0]" /> {t("useMyLocation")}
                </button>
            ...
            <section className="card p-6 border border-[#E3EAF1] shadow-[0_2px_12px_rgba(18,58,99,0.04)] space-y-4">
              <div className="flex items-center justify-between border-b border-[#F0F4F8] pb-3">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-[16px] font-bold text-[#172334]">{t("shifts")}</h3>
                    <p className="text-[12px] text-[#8A97A8]">{t("shiftsSub")}</p>
                  </div>
                </div>
                {editingShift !== "new" && (
                  <button
