...
export default function DashboardView({
  ...
  return (
    <div className="space-y-5 pb-10">
      ...
      {/* Quick Access Factory Modules */}
      <div className="grid grid-cols-3 gap-2 sm:grid-cols-6 sm:gap-3">
        <Link
          href="/kra"
          className="flex flex-col items-center justify-center gap-1.5 rounded-2xl border border-[#E2E8F0] bg-white p-3 text-center shadow-xs transition hover:border-[#1E6FE0] active:scale-95 dark:border-[#1E293B] dark:bg-[#0F172A]"
        >
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-50 text-[#1E6FE0] dark:bg-blue-950/50">
            <Target className="h-5 w-5" />
          </div>
          <span className="text-[11.5px] font-bold text-[#0F172A] dark:text-white leading-tight">KRAs & Goals</span>
        </Link>

        <Link
          href="/roster"
          className="flex flex-col items-center justify-center gap-1.5 rounded-2xl border border-[#E2E8F0] bg-white p-3 text-center shadow-xs transition hover:border-purple-500 active:scale-95 dark:border-[#1E293B] dark:bg-[#0F172A]"
        >
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-purple-50 text-purple-600 dark:bg-purple-950/50">
            <Clock className="h-5 w-5" />
          </div>
          <span className="text-[11.5px] font-bold text-[#0F172A] dark:text-white leading-tight">Shift Roster</span>
        </Link>

        <Link
          href="/documents"
          className="flex flex-col items-center justify-center gap-1.5 rounded-2xl border border-[#E2E8F0] bg-white p-3 text-center shadow-xs transition hover:border-emerald-500 active:scale-95 dark:border-[#1E293B] dark:bg-[#0F172A]"
        >
          ...
          <span className="text-[11.5px] font-bold text-[#0F172A] dark:text-white leading-tight">KYC & Letters</span>
        </Link>

        <Link
          href="/recognition"
          className="flex flex-col items-center justify-center gap-1.5 rounded-2xl border border-[#E2E8F0] bg-white p-3 text-center shadow-xs transition hover:border-amber-500 active:scale-95 dark:border-[#1E293B] dark:bg-[#0F172A]"
        >
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-amber-50 text-amber-600 dark:bg-amber-950/50">
            <Trophy className="h-5 w-5" />
          </div>
          <span className="text-[11.5px] font-bold text-[#0F172A] dark:text-white leading-tight">Star Workers</span>
        </Link>

        <Link
          href="/helpdesk"
          className="flex flex-col items-center justify-center gap-1.5 rounded-2xl border border-[#E2E8F0] bg-white p-3 text-center shadow-xs transition hover:border-rose-500 active:scale-95 dark:border-[#1E293B] dark:bg-[#0F172A]"
        >
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-rose-50 text-rose-600 dark:bg-rose-950/50">
            <LifeBuoy className="h-5 w-5" />
          </div>
          <span className="text-[11.5px] font-bold text-[#0F172A] dark:text-white leading-tight">Helpdesk</span>
        </Link>

        <Link
          href="/calendar"
          className="flex flex-col items-center justify-center gap-1.5 rounded-2xl border border-[#E2E8F0] bg-white p-3 text-center shadow-xs transition hover:border-indigo-500 active:scale-95 dark:border-[#1E293B] dark:bg-[#0F172A]"
        >
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600 dark:bg-indigo-950/50">
            <CalendarDays className="h-5 w-5" />
          </div>
          <span className="text-[11.5px] font-bold text-[#0F172A] dark:text-white leading-tight">Calendar</span>
        </Link>
      </div>
