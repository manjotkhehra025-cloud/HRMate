...
export default function VerifyView({
  ...
  if (!data || !data.user) {
    return (
      <div
        className="fixed inset-0 overflow-y-auto overflow-x-hidden bg-[#0B132B] px-4 py-12 flex flex-col items-center justify-center text-white"
...
Issued by G.D. Foods HR Security System`;
  ...
  return (
    <div
      className="fixed inset-0 overflow-y-auto overflow-x-hidden bg-[#070D18] text-white selection:bg-[#1E6FE0] selection:text-white"
      style={{ WebkitOverflowScrolling: "touch" }}
    >
      {/* Printable verification slip styles */}
      ...
      <main className="min-h-full w-full max-w-3xl mx-auto px-3.5 py-6 sm:py-10 flex flex-col items-center justify-start pb-28">
        <div
          id="verify-container"
          className="w-full rounded-[32px] overflow-hidden bg-[#0F172A] border border-white/15 shadow-2xl"
        >
          {/* Top Header Banner */}
          <div className={classNames(
            "relative px-5 py-5 sm:px-6 sm:py-6 border-b",
            isOfficial
            ...
            <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  <h1 className="text-[18px] sm:text-[21px] font-black tracking-tight text-white leading-tight">
                    {company.factoryName}
                  </h1>
                  <p className="text-[11px] sm:text-[11.5px] font-bold uppercase tracking-widest text-white/90 mt-0.5">
          ...
          {/* View Format Selector & Working Action Bar */}
          <div className="no-print px-4 sm:px-6 pt-4 pb-3 flex flex-wrap items-center justify-between gap-3 border-b border-white/10 bg-[#0F172A]">
            <div className="flex rounded-xl bg-white/10 p-1">
              <button
                type="button"
                onClick={() => setFormat("table")}
                className={classNames(
                  "flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-[12px] sm:text-[12.5px] font-bold transition",
              ...
              >
                <FileText className="h-3.5 w-3.5 text-emerald-600" /> Plain Text
              </button>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1.5 rounded-xl bg-[#1E6FE0] hover:bg-[#1656B8] px-3.5 py-1.5 text-[12px] font-bold text-white shadow transition active:scale-95"
              >
          ...
          {/* Format Content Body (Fully Scrollable Table) */}
          <div className="p-4 sm:p-6 bg-[#0F172A]">
                ...
                <table className="w-full text-left text-[13px] sm:text-[13.5px]">
                  <tbody className="divide-y divide-white/10">
                    <tr className="hover:bg-white/5 transition">
                      <td className="w-2/5 sm:w-1/3 px-3.5 sm:px-4 py-3 font-bold text-slate-400 flex items-center gap-2">
                        <User className="h-4 w-4 text-emerald-400 shrink-0" />
                        Employee ID
                      </td>
                      <td className="px-3.5 sm:px-4 py-3 font-mono font-black text-white text-[14px] sm:text-[15px]">
                        {user.emp_code}
                      </td>
                    </tr>

                    <tr className="hover:bg-white/5 transition">
                      <td className="px-3.5 sm:px-4 py-3 font-bold text-slate-400 flex items-center gap-2">
                        <User className="h-4 w-4 text-emerald-400 shrink-0" />
                        Full Name
                      </td>
                      <td className="px-3.5 sm:px-4 py-3 font-black text-white">
                        {user.name}
                      </td>
                    </tr>
                    ...
                    <tr className="hover:bg-white/5 transition">
                      ...
                      <td className="px-3.5 sm:px-4 py-3 font-bold">
                        {isOfficial ? (
                    ...
                    <tr className="hover:bg-white/5 transition">
                      ...
                      <td className="px-3.5 sm:px-4 py-3 font-bold text-emerald-400">
                        {user.department || "Production"}
                      </td>
                    </tr>
                    ...
                    <tr className="hover:bg-white/5 transition">
                      ...
                      <td className="px-3.5 sm:px-4 py-3 font-semibold text-slate-200">
                    ...
                    <tr className="hover:bg-white/5 transition">
                      ...
                      <td className="px-3.5 sm:px-4 py-3 font-semibold text-white">
                    ...
                    <tr className="hover:bg-white/5 transition">
                      ...
                      <td className="px-3.5 sm:px-4 py-3 font-semibold text-slate-300">
                    ...
                    <tr className="hover:bg-white/5 transition">
                      ...
                      <td className="px-3.5 sm:px-4 py-3 font-mono font-bold text-emerald-400">
                    ...
                    <tr className="hover:bg-white/5 transition">
                      ...
                      <td className="px-3.5 sm:px-4 py-3 font-bold text-white">
                        {company.factoryName}
                      </td>
                    </tr>
                    ...
                    <tr className="hover:bg-white/5 transition">
                      ...
                      <td className="px-3.5 sm:px-4 py-3 text-[12.5px] text-slate-300">
            ...
            <div className="mt-5 flex flex-wrap items-center justify-between gap-3 no-print">
              <button
                type="button"
                onClick={triggerPrint}
                className="flex-1 flex items-center justify-center gap-2 rounded-2xl bg-[#1E6FE0] px-5 py-3 text-[13.5px] font-bold text-white shadow-lg active:scale-98 transition"
              >
              ...
              <button
                type="button"
                onClick={copyText}
                className="flex items-center justify-center gap-2 rounded-2xl bg-white/10 px-5 py-3 text-[13.5px] font-bold text-white shadow active:scale-98 transition"
              >
            ...
            {/* Security & Official Clearance Notice */}
