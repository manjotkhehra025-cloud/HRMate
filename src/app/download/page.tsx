...
export default function DownloadPage() {
  ...
  return (
    <div
      className="flex h-full min-h-0 flex-1 flex-col overflow-x-hidden overflow-y-auto bg-[#F4F7FB] text-[#0F172A] selection:bg-[#1E6FE0] selection:text-white dark:bg-[#0B132B] dark:text-white"
    ...
    >
      ...
      {/* Main Container */}
      <main className="mx-auto w-full max-w-5xl px-4 py-6 sm:px-8 sm:py-10 pb-20">
        {/* If inside Native App: Show Active Status instead of Download prompts */}
        {isNative ? (
          <div className="relative overflow-hidden rounded-[32px] border border-emerald-500/40 bg-gradient-to-br from-[#0B192C] via-[#064E3B]/60 to-[#0B192C] p-6 sm:p-12 text-white shadow-2xl text-center">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-emerald-500/20 ring-2 ring-emerald-400 mb-4">
              <Check className="h-8 w-8 text-emerald-400" />
            </div>
            <h1 className="text-[26px] sm:text-[34px] font-black text-white">
            ...
            <div className="mt-6 flex justify-center">
              <Link
                href="/dashboard"
                className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-[#1E6FE0] to-[#10B981] px-6 py-3.5 text-[14px] font-black text-white shadow-xl hover:brightness-110 active:scale-95"
              >
          ...
          /* Web Browser View: Download Hero Card */
          <div className="relative overflow-hidden rounded-[32px] border border-[#1E6FE0]/30 bg-gradient-to-br from-[#0B192C] via-[#0F2D54] to-[#0B192C] p-6 sm:p-12 text-white shadow-2xl">
            ...
            <div className="absolute -top-24 -right-24 h-96 w-96 rounded-full bg-[#1E6FE0]/25 blur-3xl pointer-events-none" />
            <div className="absolute -bottom-24 -left-24 h-96 w-96 rounded-full bg-[#10B981]/20 blur-3xl pointer-events-none" />
        ...
        <div className="mt-8 rounded-3xl border border-[#E2E8F0] bg-white p-6 sm:p-8 shadow-sm dark:border-[#1E293B] dark:bg-[#0F172A]">
